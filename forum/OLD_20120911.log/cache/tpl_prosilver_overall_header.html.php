...
<meta name="keywords" content="<?php echo (isset($this->_rootref['PAGE_TITLE'])) ? $this->_rootref['PAGE_TITLE'] : ''; ?>" />
<meta name="description" content="<?php echo (isset($this->_rootref['PAGE_TITLE'])) ? $this->_rootref['PAGE_TITLE'] : ''; ?>" />
...
<script language="Javascript" type="text/javascript" src="/js/jquery.yapro.Spelling/latest.js"></script>
<script language="Javascript" type="text/javascript" src="/js/jquery.yapro.alert/latest.js"></script>
<link href="/js/jquery.yapro.alert/latest.css" type="text/css" rel="stylesheet">
</head>
...
<?php echo (isset($this->_rootref['SYSTEM_TOP'])) ? $this->_rootref['SYSTEM_TOP'] : ''; ?>
...
<div id="wrap">
	...
	<div id="page-header">
		<div class="navbar">
			...
			<ul class="linklist navlinks"><?php if ($this->_rootref['S_DISPLAY_SEARCH'] && ! $this->_rootref['S_IN_SEARCH']) {  ?>
